...
export default function AdminDashboard({accessToken, baseUrl,user, kamar, kamarKosong, kamarTerisi, pendapatan, actifity, }: Props) {
    ...
    <div className="flex h-screen bg-gradient-to-b from-green-50 to-green-100">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          ...
          {activeTab === "rooms" && <RoomsTypeContent baseUrl={baseUrl as string} accessToken={accessToken}/>}
          {activeTab === "users" && <UsersContent accessToken={accessToken}/>}
          {activeTab === "roomList" && <RoomContent  accessToken={accessToken}/>}
